...
<div class="page-wrapper">
    <div class="">
        ...
        <div class="search">
            <div class="container">
                <form:form class="form-horizontal" modelAttribute="modelTimKiemUser" role="form" id="listForm" action="/web/home" method="GET">
                    <div class="row">
                        <div class="col-12 col-md-3">
                            <div class="search-item">
                                <p class="search-text">Chọn chung cư</p>
                                <form:select class="search-option" name="search-option" id="search-option" path="idChungCu">
                                    <form:option value="">---Chọn chung cư---</form:option>
                                    <form:options items="${mapAllChungCu}"/>
                                </form:select>
<%--                                <form:select class="search-option" name="search-option" id="search-option" path="idChungCu">--%>
<%--                                    <form:option value="">---Chọn chung cư---</form:option>--%>
<%--                                    <form:option value="1"> Bình dan</form:option>--%>
<%--                                    <form:option value="2"> Bình dan</form:option>--%>
<%--                                    <form:option value="3"> Bình dan</form:option>--%>
<%--                                </form:select>--%>
                            </div>
                        </div>
<%--                        <div class="col-12 col-md-3">--%>
<%--                            <label class="name search-text">Tên chung cư</label>--%>
<%--                            &lt;%&ndash;															<input type="text" class="form-control" name="tenChungCu" value="${modelTimKiem.tenChungCu}">&ndash;%&gt;--%>
<%--                            <input path="tenChungCu" class="form-control search-item search-option search-option"/>--%>

<%--                        </div>--%>
                        <div class="col-12 col-md-3">
                            <div class="search-item">
                                <p class="search-text">Tầng</p>
                                <form:input path="tang" class="form-control search-item search-option search-option"/>
                            </div>
                        </div>
                        <div class="col-12 col-md-3">
                            <div class="search-item">
                                <p class="search-text">Loại căn hộ</p>
                                <form:select class="search-option" name="search-option" id="search-option" path="loaiCanHo">
                                    <form:option value="">---Chọn chung cư---</form:option>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="search-item">
                                <p class="search-text"> Diện tích từ</p>
                                <form:input path="dienTichTu" class="form-control search-item search-option search-option"/>
                            </div>
                        </div>
                        <div class="col-12 col-md-3">
                            <div class="search-item">
                                <p class="search-text"> Diện tích đến</p>
                                <form:input path="dienTichDen" class="form-control search-item search-option search-option"/>
                            </div>
                        </div>
                        <div class="col-12 col-md-3">
                            <div class="search-item">
                                <p class="search-text"> Gia bán từ</p>
                                <form:input path="giaBanTu" class="form-control search-item search-option search-option"/>
                            </div>
                        </div>
                        <div class="col-12 col-md-3">
                            <div class="search-item">
                                <p class="search-text"> Giá ban đến</p>
                                <form:input path="giaBanDen" class="form-control search-item search-option search-option"/>
                            </div>
                        </div>
        ...
        <div class="content">
            <div class="content-title">
                <div class="title-cover">
                    <span id="title1">Một số căn hộ cho bạn tham khảo</span>
...
<%--                                            <img src="${item.image}" alt="Hình ảnh sản phẩm">--%>
                                            <img src="${item.image}" alt="Hình ảnh sản phẩm" width="346" height="248">
                                        </div>

                                        <div class="product1-conntent">
                                            <div class="product1-conntent-header">
                                                <a href="">${item.tenCanHo}</a>
                                            </div>
                                            ...
                                            <ul class="product1-conntent-list">
                                                ...
                                                <li class="product1-conntent-item">
                                                    ...
                                                    <span>Loại căn hộ : ${item.loaiCanHo}</span>
                                                </li>
                                                <li class="product1-conntent-item">
                                        ...
                                        <div class="product1-footer">
                                            <span class="product1-footer-cost">${item.giaBan}</span>
                                            <button class="product1-footer-detail"><a href="/web/chitiet/${item.id}"
